...
const nextConfig: NextConfig = {
  ...
  // El generador de etiquetas QR (/admin/contracts/[id]/etiquettes) lee el logo desde
  // public/ con fs. En el build standalone public/ no se traza solo: hay que incluir el
  // asset explícitamente para que viaje a la función serverless.
  outputFileTracingIncludes: {
    '/admin/contracts/[id]/etiquettes': ['./public/images/logos/logo-amd.png'],
  },
