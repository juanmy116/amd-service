...
export default function LoginForm() {
  ...
  // Dentro de la app instalada (iOS) Google OAuth es un callejón sin salida: abre fuera de la
  // app y la sesión no vuelve. Se detecta tras montar (no hay `window` en el servidor).
          ...
          <>
            ...
            {isStandalone ? (
              <p className="text-xs text-ink-muted text-center mt-6">
                Dans l&apos;application, connectez-vous avec votre email et votre mot de passe.
              </p>
            ) : (
              <>
